...
export class LambdaKMSStore implements Source {
   ...
   * @param kmsARN the full ARN of the KMS used to descrypt the secrets returned.
   * @param secrets a comma separated list of the secret sources to consider.
   * @param configKeys all of the keys that you want to retrieve from the configuration source later.
   */
