...
describe('SecretsManagerStore', async () => {
  ...
  describe('Positive', async () => {
    ...
    it('should return a property from get() that exists', async () => {
      sandbox.stub(secretsManager, 'getSecretValue').resolves({ SecretString: '{"aboolean": true, "aninteger": 1}' })
    ...
    it('should return a property from get() that exists as Date', async () => {
      sandbox.stub(secretsManager, 'getSecretValue').resolves({ SecretString: '{"adate": "2012-04-23T18:25:43.511Z", "aninteger": 1}' })
  ...
  describe('Negative', async () => {
    it('should fail to get() on secret that exists, but is empty', async () => {
      sandbox.stub(secretsManager, 'getSecretValue').resolves({ SecretString: '' })
      try {
