...
describe('LambdaKMSStore', async () => {
  ...
  // it('should refresh successfully', async function (done) {
  //   // sandbox.stub(lambda, 'invoke').resolves(Promise.resolve({StatusCode: 200}))
  //   // this.timeout(5000)
  //   console.log('lambdaKMSStore ------ ', lambdaKMSStore)
